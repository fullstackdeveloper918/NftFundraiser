          ...
          <div className="col-12 col-lg-8 relative">
            <div className="item-info">
              <div className="item-thumb text-center">
                <>
                  <div>
                    {latprojdetail?.user_data?.user_id === userdet?.user_id &&
              ...
              <div className="progress_nft ">
                  ...
                  <span>
                    ...
                    <span className="nft_price">
                      ...
                      {Number(Math.round(latprojdetail.project_count)) *
                        Number(Math.round(matic["matic-network"]?.cad))}{" "}
                      raised of $
                      {Math.round(Number(latprojdetail.price)) *
                        Number(Math.round(matic["matic-network"]?.cad))}{" "}
                      Cdn Goal
                    </span>
                    <div>
                ...
                <div className="d-flex flex-wrap gap-5 justify-content-start">
                  <>
                    <a
                      href={`${
                        latprojdetail?.number_of_pending === 0 ? "#" : "#invest"
                      }`}
                    >
                      <Button
                        disabled={latprojdetail?.number_of_pending === 0}
                        variant="primary"
                    ...
                    <Button
                      disabled={latprojdetail?.number_of_pending === 0}
                      className="btn sm:ml-2 btn-bordered-white m-0"
                      variant="primary"
                      onClick={() => {
                        if (latprojdetail?.number_of_pending !== 0)
                ...
                {latprojdetail?.user_invest &&
                latprojdetail?.user_invest?.length ? (
                  [
                    ...new Map(
                      latprojdetail?.user_invest
                        ?.slice(0, 3)
                          ...
                          <div className="lorem_done p-0">
                            ...
                            <span>
                              ...
                              <div>
                                ...
                                ${item.price} Cdn /{" "}
                                {Math.round(
                                  Number(latprojdetail.price) *
                                    Number(matic["matic-network"]?.cad)
                                )}{" "}
                                MATIC ({days_difference} days ago)
                              </div>
                            </span>
                          </div>
                        </li>
