...
const NftDetails = (props) => {
  ...
  useEffect(() => {
    GetMatic(setMatic);
    dispatch(NftList(slug.id, setLoading, history));
    dispatch(ProjectDetail(slug.id, history));
  }, [slug, dispatch]);
        ...
        <div className="row justify-content-between content_project px-0">
                  ...
                  {loading ? (
                    ...
                    <>
                      {nftdetail.extention === "Player" && (
                        <video width="100%" controls src={nftdetail.image} />
                      )}
                      {nftdetail.extention === "modal" && (
                        <DModal vdo={nftdetail.image} />
                      )}
              ...
              <div className="card no-hover position-relative">
                ...
                {nftdetail.is_mint === "0" ? (
                  <div className="eddlbtton d-flex  align-items-center mt-3">
                    <>
                      <button
                        className="w-full btn btn-bordered-white btn-smaller mt-3 d-flex align-items-center justify-content-center py-1 mx-2"
                        style={{ color: "#FFF" }}
                  ...
                  <>
                    {nftdetail.sold_nft === "1" ? (
                      <div className="eddlbtton d-flex  align-items-center mt-3">
                        <>
                          <span
                            className="purchase_btn  mt-3 d-flex align-items-center justify-content-center py-1 mx-2"
                            disabled
                          >
                            SOLD OUT
                          </span>
                      ...
                      <div className="eddlbtton d-flex  align-items-center">
                        <>
                          <span
                            className="purchase_btn d-flex align-items-center justify-content-center py-1 mx-2"
                            disabled
                          >
          ...
          <div className="col-12 md:col-8 mt-4">
            <div class="user-description ">
              ...
              <ReadMore
                data={nftdetail.description}
                className="nft-detail-nft "
              />
            </div>
          </div>
                ...
                <div className="nft-price">
                  ...
                  <span>
                    <small>
                      {nftdetail.amount} / $
                      {nftdetail.amount *
                        Math.round(matic["matic-network"]?.cad)}{" "}
                      Cdn{" "}
                    </small>
                  </span>
                </div>
          ...
          <div className="col-lg-8 col-12">
            <div className="profile_detail mt-4">
              <NftdataTable slug={slug} />
            </div>
          </div>
          <div className="col-12 mt-4">
            <div className="container table-detail">
              <NftAuctiondataTable slug={slug} />
            </div>
          </div>
        </div>
      </div>
