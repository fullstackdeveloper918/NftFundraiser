          ...
          <div className="row">
            <div className="col-12 col-sm-6 col-lg-3 res-margin">
              ...
              <div className="footer-items">
                ...
                <p>
                  Mint NFTs that are based on real-life projects or events
              ...
              <div className="footer-items">
                ...
                <ul>
                  <li className="nav-item">
                    <a onClick={() => handleCreate()} className="">
                      Create Project
                    </a>
                  </li>
                  {/* <li><Link to="/create" onClick={handleCreate}>Create Project</Link></li> */}
                  <li>
                    <Link to={`/all/${"LatestProjects"}`}>Explore NFTs</Link>
                  </li>
                  <li>
