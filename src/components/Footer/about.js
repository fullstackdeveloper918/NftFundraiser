...
console.log('abot.description', about.description)
  useEffect(() => {
    dispatch(AboutUsAction());
  }, [dispatch]);
//   {employees.map((employee, index) => {
   
//   const htmlContent =about.description
...
//     ) {
//       const videoId = node.attribs.src.split("/").pop();
//       const opts = {
//         height: "315",
//         width: "560",
//       };
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 col-lg-12">
            ...
            {/* <div>{ReactHtmlParser(about && about.description, { transform })}</div> */}
            <div className='termsandconditions' dangerouslySetInnerHTML={{ __html: about?.description }} />
            {/* <div>{about?.description}</div> */}
          </div>
          {/* <video title="YouTube video player" src="https://www.youtube.com/embed/p_zD3v843dU" width="560" height="315" frameBorder="0" allowFullScreen /> */}
      {/* <iframe title="YouTube video player" src="https://www.youtube.com/embed/yxxkVs6WjLY" width="560" height="315" frameBorder="0" allowFullScreen></iframe> */}
        </div>
      </div>
    </section>
  );
