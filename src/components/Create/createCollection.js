...
function MyVerticallyCenteredModal(props) {
  ...
  const OnSubmit = (dat) => {
    ...
    dispatch(
      CreateCollectionAction({ dat, imageBanner, props, setLoading, history })
    );
  };
      ...
      >
        <Modal.Header>
          <Modal.Title id="contained-modal-title-vcenter">
            {loading ? <>Please wait ...</> : <>Create Collection</>}
          </Modal.Title>
          <div>
            <a>
              <i
                ...
                <div className="row">
                  ...
                  <div className="col-6">
                    <div className="form-group mt-3">
                      ...
                      {errors.short_url?.type === "required" && (
                        <p style={{ color: "red" }} role="alert">
                          Web URL is required
                        </p>
                      )}
                    ...
                    <div className="form-group">
                      ...
                      <div>
                        <span className="logo-dis">
                          ...
                          <br />
                          Banner should be 1500 px wide x 500 px high
                        </span>
                      </div>
                    </div>
                  </div>
