          ...
          <div className="col-12 col-md-9">
            ...
            <div className="mt-5 mt-lg-0 mb-4 mb-lg-5">
              <div className="intro-content">
                <>
                  <h3 className="mt-3 mb-0">Upload NFT</h3>
                  <p>
                    {" "}
                    Allowed types: JPG, PNG, GIF, SVG, MP4, WEBM, MP3, WAV, OGG,
                    GLB, GLTF
                  </p>
                ...
                <div>
                  {loading ? (
                    ...
                    <div
                      className={
                        current === 1 ? styles.showForm : styles.hideForm
                      }
                    >
                      <Form
                        form={form}
