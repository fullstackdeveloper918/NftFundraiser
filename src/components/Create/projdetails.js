              ...
              action={
                <>
                  <i
                    ...
                    onClick={() => setProjModalShows(true)}
                  ></i>
                  <ProTypePopup
                    id={slug}
                    show={projmodalShows}
          ...
          <div className="col-12 col-lg-8">
            <div className="item-info">
              <div className="item-thumb text-center">
                <div>
                  <i
                    class="fa-solid fa-pen-to-square item-thumb-edit"
            ...
            <div className="fundraiser mt-4 p-0">
              <div className="lorem_done">
                ...
                <span className="cutom_dis">
                  {" "}
                  {
                    latprojdetail?.user_data?.organization_detail
                      ?.organization_name
                  }{" "}
                  is organizing this project.
                </span>
              </div>
            </div>
          </div>
              ...
              <div>
                <div className="progress_nft mb-3">
                  <div className="progress_main">
                    <span>
                      <span className="nft_price">
                        $
                        {Number(projdetail.project_count) *
                          Number(matic["matic-network"]?.cad)}{" "}
                        raised of $
                        {Number(projdetail.price) *
                          Number(Math.round(matic["matic-network"]?.cad))}{" "}
                        Cdn{" "}
                      </span>
                      <div>
                        <span className="nft_price">
                          ({projdetail.project_count} of {projdetail.price}{" "}
                          MATIC )
                        </span>
                      </div>
                      <div className="progressbar">
                        <ProgressBar
                          varient="success"
                          now={projdetail.project_percentage}
                        />
                      </div>
                      <p className="donation-count">
                        ${projdetail.project_count} Cdn RAISED
                      </p>
                    </span>
                  </div>
                  <div className="d-flex justify-content-start">
                    <a
                      href={`${
                        projdetail?.number_of_pending === 0 ? "#" : "#invest"
                      }`}
                    >
                      <Button
                    ...
                    projdetail?.nft_data[0]?.is_mint == 0 ? (
                      <Button
                        ...
                        variant="primary"
                        onClick={() => {
                          if (projdetail?.number_of_pending !== 0) {
                            Swal.fire("Please mint your NFTs");
                          }
                        }}
                      >
                        Share
                      ...
                      <>
                        <Button
                          className=" btn  btn-bordered-white m-0 mr-2"
                          onClick={() => setModalShowrefer(true)}
                          variant="primary"
                        >
                          Share
                        </Button>
                  ...
                  {projdetail?.user_invest &&
                  projdetail?.user_invest?.length ? (
                    [
                      ...new Map(
                        projdetail?.user_invest
                          ?.slice(0, 3)
                            ...
                            <div className="lorem_done p-0">
                              <span>
                                ...
                                >
                                  ...
                                  />
                                  <path
                                    d="M12 12C13.2416 12 14.248 10.9926 14.248 9.75C14.248 8.50736 13.2416 7.5 12 7.5C10.7584 7.5 9.75197 8.50736 9.75197 9.75C9.75197 10.9926 10.7584 12 12 12Z"
                                    stroke="#4528dc"
                                    stroke-width="1.5"
                                    stroke-miterlimit="10"
                                    stroke-linecap="round"
                                  ...
                                  />
                                  <path
                                    d="M14.9974 14.25C16.6528 14.25 17.9737 15.7453 16.8057 16.9195C15.703 18.0281 13.9431 18.75 12 18.75C10.0569 18.75 8.29702 18.0281 7.19428 16.9195C6.02632 15.7453 7.34722 14.25 9.00262 14.25L14.9974 14.25Z"
                                    stroke="#4528dc"
                                    stroke-width="1.5"
                                    stroke-miterlimit="10"
                                    stroke-linecap="round"
                ...
                <div className="col-12 col-sm-6 col-lg-3 item explore-item">
                  <div className="card no-hover m-0 add-nft ">
                    <div class="image-over relative">
                      <Link
                        to={`/addnft/${projdetail.slug}?projectid=${projdetail.id}`}
                      >
                        + Add NFT{" "}
                      </Link>
                    </div>
                      ...
                      <div className="image-over relative">
                        ...
                        <div className="token">
                          ...
                          <span className="cards-icons">
                            {x.is_mint == 0 && (
                              <Link
                                to={`/nft/details/${x.slug}?project=${slug}`}
                              >
                        ...
                        <div className="card-body">
                          ...
                          <div className="d-flex justify-content-between align-items-end mt-1 mb-1 ">
                            <span
                              ...
                              dangerouslySetInnerHTML={{
                                __html: x.description.slice(0, 35),
                              }}
                            />
                          </div>
                          <div className="mint d-flex justify-content-between button_group buy-invest-btn align-items-center nft-price">
                            {x.is_mint == 0 ? (
                              ...
                              <>
                                {x?.user_data?.user_id !==
                                projdetail?.user_data?.user_id ? (
                                  <button
                                    className="btn py-2 ml-lg-auto btn-bordered-white"
                                    disabled
                                  >
                                    <a>SOLD OUT</a>
                                  </button>
