...
const RefralTransdataTable = (props) => {
  ...
  const HandleProj = (e) => {
    ...
    dispatch(
      ProjectDetail(e?.currentTarget?.value ? e?.currentTarget?.value : slug,history)
    );
    setNftslug(" ");
    // }
    if (nftSlug !== " ") {
        ...
        <div className="container">
          <Tabs>
            ...
            <TabPanel>
              <div className="pb-5">
                ...
                <div className="main-heading">
                  <div>
                    Affiliates get 30% on first level NFT referred sales at
                    Karmatica.io only.
                  </div>
                  <div>
                    Creators get 10% of secondary NFT sales for the lifetime of
                    the project.
                  </div>
                </div>
                <div className="referal-main">
                  ...
                  <ul>
                    <li>
                      <span>69%</span> goes to Creator{" "}
                    </li>
                    <li>
                      <span>30%</span> goes to Affiliate
                    </li>
                    <li>
                      <span>1% </span>to Karmatica
                    </li>
                  </ul>
                </div>
                <div className="referal-main">
                  ...
                  <ul>
                    <li>
                      {" "}
                      <span>84%</span> goes to BUYER 1
                    </li>
                    <li>
                      {" "}
                      <span>10%</span> goes to NFT Creator
                    </li>
                    <li>
                      {" "}
                      <span>5% </span>goes to Affiliate{" "}
                    </li>
                    <li>
                      {" "}
                      <span>1% </span>to Karmatica
                          ...
                          return (
                            <>
                              <tr className="contract-address">
                                <td>
                                  <Link to={`/nftprojdetails/${items?.slug}`}>
                                ...
                                <td>
                                  <Link
                                    to={`/popularcollection/details/${items?.collection_slug}`}
                                  >
                                    {items?.collection_name}
                                  </Link>
                                </td>
                                <td>
                                  {items?.pay_from?.slice(0, 4)}...
                                  {items.pay_from?.slice(35, 44)}
                                </td>
                                <td>
                                  {items?.pay_to?.slice(0, 4)}...
                                  {items?.pay_to?.slice(35, 44)}
                                </td>
                                <td>
                                  <a
                                    target="_blank"
                                    href={`https://polygonscan.com/tx/${items?.transaction_hash}`}
                                  >
                                    {items?.transaction_hash?.slice(0, 4)}...
                                    {items?.transaction_hash?.slice(35, 44)}
                                  </a>
                                </td>
                              </tr>
                            </>
            ...
            <TabPanel>
              ...
              <h6 className="top-content">
                Share with friends using our NFT widget on your website.
                <br />
                Upload your NFTs to get an affiliate referral link to earn 30%
                of NFTs sold in MATIC
              </h6>
                )}
                ...
                <div className="form-group">
                  {projects?.data?.length > 0 ? (
                    <>
                      ...
                      <select name="category_id" onChange={HandleProj}>
                        <option
                          value={projects.data && projects?.data[0]?.title}
                          selected
                          style={{ color: "#495057" }}
                        >
                          {projects.data && projects?.data[0]?.title}{" "}
                        </option>
              ...
              <div className="col-12 mt-4">
                <div className="nfts_main" id="invest">
                  ...
                  <div className="row items mt-0 explore-items px-0">
                    {copy === true && <span className="copytext">Copied!</span>}
                    {projdetail?.nft_data?.map((x, idx) => {
                      ...
                      return (
                        <>
                          ...
                          >
                            <div
                              className="card no-hover m-0"
                              onClick={() => {
                                setNftslug(x.slug);
                                setWidgetModalShow(true);
                              }}
                            ...
                            >
                              ...
                              <div className="card-caption px-0 col-12 ">
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="d-flex justify-content-between align-items-end mt-1 mb-1 ">
                                    Project Name:
                                    <span>
                                      {x?.project_name?.slice(0, 12)}..
                                    </span>
                                  </div>
                                  <div className="d-flex justify-content-between align-items-end mt-1 mb-1 ">
                                    NFT Name :
                                    <span>{x?.title?.slice(0, 12)}..</span>
                                  </div>
                                  <div className="d-flex justify-content-between align-items-end mt-1 mb-1 ">
                                  ...
                                  <div className="d-flex justify-content-between align-items-end mt-1 mb-1 ">
                                    NFT End-Date :
                                    <span>
                                      {dayjs(x?.end_date).format("DD MMM YYYY")}
                                    </span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <i
                                ...
                                onClick={() => setWidgetModalShow(true)}
                              ></i>
                            </div>
                          </div>
                          <WidgetPopup
