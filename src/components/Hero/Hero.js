      ...
      <div className="container">
        <div className="row ">
          <div className="col-12 col-md-6 col-lg-7">
            <h1 className="mt-4">
              Buy or create NFTs to fund projects. Earn 30% by sharing with
              friends.
            </h1>
            ...
            <div className="button-group">
              ...
              <a className="btn btn-bordered-white" onClick={handleCreate}>
          ...
          <div className="col-12 col-md-6 col-lg-4 auction-slider auctions-slides">
            ...
            <div
              key={`auc_${mostactivityProjects[0]?.id}`}
              className="item card"
            >
              <div className="image-over">
                <Link to={`/projects/${mostactivityProjects[0]?.slug}`}>
                  <img
                    class="card-img-top"
                    src={mostactivityProjects[0]?.image}
                    alt=""
                  ></img>
                </Link>
              </div>
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="card-caption col-12 p-0">
                    ...
                    <div className="card-body">
                      <h5 className="mb-0">
                        {mostactivityProjects[0]?.title?.slice(0, 16)}
                      </h5>
                      ...
                      <div className="seller d-flex align-items-center my-2">
                        ...
                        {mostactivityProjects[0]?.user_data.username?.slice(
                              0,
                              12
                            )}
                        </h6>
