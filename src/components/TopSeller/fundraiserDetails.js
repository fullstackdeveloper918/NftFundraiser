...
const FundraiserDetail = () => {
  ...
  const [modalShoweditfunddes, setModalShoweditfunddesc] =
    React.useState(false);
  const [modalShoweditfundlogo, setModalShoweditfundlogo] =
    React.useState(false);
        ...
        <div className="row justify-content-between p-0">
          <div className="col-12">
            <div className="nft-edit-icon">
              <span className="title_main">
                {funddetail?.organization_detail?.organization_name}
              </span>
          ...
          <div className="col-12 col-lg-8">
            <div className="item-info">
              <div className="item-thumb text-center">
                <div>
                  {funddetail?.user_id === userDetail?.user_id && (
                    <i
                      ...
                      onClick={() => setModalShoweditfundimg(true)}
                    ></i>
                  )}
                  <EditBanner
                ...
                <img
                  src={funddetail?.organization_detail?.banner_image}
                  alt=""
                />
                {/* <img src="/img/ph.jpg" /> */}
            ...
            <div className="lorem_done edit_icon_des mt-3">
              <img
                src={userdet?.organization_detail?.logo}
                width="32px"
                height="32px"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <span className="cutom_dis">
                {" "}
                {funddetail?.organization_detail?.organization_name} is
              ...
              <div>
                {funddetail?.user_id === userDetail?.user_id && (
                  <i
                    ...
                    onClick={() => setModalShoweditfundlogo(true)}
                  ></i>
                )}
                <EditLogo
            ...
            <div className="custam_col mt-3 mt-lg-0">
              <h5 class="user_title justify-content-between">
                ...
                <div>
                  {funddetail?.user_id === userDetail?.user_id && (
                    <i
                      className="fa-solid fa-pen"
                      onClick={() => setModalShoweditfunddesc(true)}
                    ></i>
                  )}
                  <DescEdit
              ...
              <div className=" no-hover">
                ...
                <div className="price d-flex justify-content-between align-items-center"></div>
              </div>
            </div>
          ...
          <div className="col-12 col-lg-4 desktop_nft">
            <div className="progress_nft  mb-3">
              <div className="progress_main">
                <span>
                  <span className="nft_price">
                    ${funddetail.total_fundraised} Cdn raised from all projects
                  </span>
                  <small> </small>
                </span>
                ...
                <div className="progressbar">
                        <ProgressBar
                          varient="success"
                          now={fundprojdetail[0]?.user_data?.organization_detail?.organization_percentage}
                        />
                      </div>
              ...
              <h5 class="user_title_1 mt-3 mb-0">
                <div>Projects</div>
              </h5>

              <ul className="m-0 custom_lis pl-0 fund_row">
                {fundprojdetail && fundprojdetail.length > 0 ? (
                  [
                    ...new Map(
                      fundprojdetail.map((item) => [item["title"], item])
                    ).values(),
                  ]
                    ?.slice(0, 3)
                    ?.map((item, idx) => {
                      ...
                      return (
                        <li>
                          <div className="lorem_done p-0">
                            ...
                            <span>
                              <div className="progress_name">{item.title} </div>{" "}
                              <div>{days_difference} days ago</div>
                            </span>
                          </div>
                        </li>
                      );
             ...
             {fundprojdetail?.length > 3 &&
              <Link className="" to={`/all/fundraise/projects/${user_id}`}>
